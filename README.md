...
当前版本：`0.3.0-beta.1`。项目采用 [MIT License](LICENSE)。

![个人数字助理完整管理台](docs/console-v0.3.png)
...
- 公开安装版与开发版统一使用完整版管理台，集中管理待办、跟进、项目、邮件、知识权限、白名单权限和沟通渠道。
- 已安装的旧版本可直接覆盖升级；用户数据目录不会随插件升级被替换。
